...
7. **The ask** — YES / no (the "no" button has other plans).
8. **Accepted** — confetti, the movie link, and a note from Command.
...
- Hand-authored SVG Minions with cursor-tracking googly eyes
- Vanilla JS screen controller, typed boot log, staged decrypt reveals
- Fredoka / DM Sans / Space Mono
